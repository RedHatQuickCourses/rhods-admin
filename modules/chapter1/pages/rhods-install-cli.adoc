...
<3> Update channel to install the operator from. For more information about finding available channels see the xref:rhods-install-cli.adoc#findchannel[Finding Update Channels] section.
<4> *installPlanApproval* attribute can be either *Automatic* or *Manual*. For more details about manual installation approval se the xref:rhods-install-cli.adoc#manual_approval[Approving Installation Manualy] section.
--
...
----
<1> The update channel to install the operator from. To find all available  channels see the the xref:rhods-install-cli.adoc#findchannel[Finding Update Channels] section.
<2> Installplans will be approved manually.
--

. Approve the installation manually. Refer to the xref:rhods-install-cli.adoc#manual_approval[Approving Installation Manualy] section for more information
+
[subs=+quotes]
----
$ *oc get installplan -n redhat-ods-operator*
...
. Check the installation progress using the operator's status information. For more information see the xref:rhods-install-cli.adoc#installprogress[Checking Installation Progress] section.
+
[subs=+quotes]
----
