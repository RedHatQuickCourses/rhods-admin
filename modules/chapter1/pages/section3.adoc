...
The following example shows how to find the status of the *Openshift Pipelines* operator installation.
[subs=+quotes]
----
*$ oc get operators*
NAME                                                  AGE
...
6. You may check the installation progress using the operator's status information. For more information see the xref:section3.adoc#installprogress[Checking Installation Progress] section.
