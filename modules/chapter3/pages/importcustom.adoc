...
image::../images/quaySettings.png[Quay Repository Settings]
...
image::../images/quayMakePublic.png[Quay Visibility Setting]
...
image::../images/rhodsImportCustomImage.png[RHODS Import Notebook]

You should now see the image in the list and enabled.

image::../images/rhodsNotebookImage.png[RHODS Custom Notebooks]
...
image::../images/rhodsDataScienceProj.png[RHODS Data Science Projects]

Give the project a name and resource name. Click the *Create* button.

image::../images/rhodsCreateProj.png[RHODS Project]

Click the *Create* button.

image::../images/rhodsCreateWrkbench.png[RHODS Workbench]
...
image::../images/rhodsCreateWrkbenchDetails.png[RHODS Workbench Details]

Once the Status changes to Running click the *Open* link.

image::../images/rhodsWorkbenchStart.png[RHODS Workbench Start]

Login to the notebook and click the *Python 3.11* notebook tile.

image::../images/rhodsNewPythonNotebook.png[RHODS Python Notebook]
...
image::../images/rhodsPipList.png[RHODS pip list]
...
image::../images/testSeaborn1.png[Seaborn Code Snippet]

Click Shift + Enter to execute the cell. You should see the graph below. 

image::../images/testSeaborn2.png[Seaborn Graph]
