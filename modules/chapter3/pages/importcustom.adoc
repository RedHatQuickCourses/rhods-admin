...
+
image::custom_image_notebook3.png[OpenShift AI Admin Notebook Images]
...
+
image::custom_image_notebook1.png[OpenShift AI Custom Notebooks]
...
+
image::create_dsp_project.png[OpenShift AI Data Science Projects]

2. Give the project a name and resource name. Click the *Create* button.
+
image::custom_image_workbench2.png[OpenShift AI Project]

3. Click the *Create* button. 
// This is covered in the earlier instruction.
+
image::custom_image_workbench1.png[OpenShift AI Workbench]
...
+
image::custom_image_workbench.png[OpenShift AI Workbench Details]
